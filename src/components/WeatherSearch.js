          ...
          <div className="form">
            ...
            {this.state.inputs.map((input, idx) => (
              <div key={input.name.toLowerCase()} className="form-group form-group-search">
                ...
                <input type="text" name={input.name.toLowerCase()} className="form-control form-control-search" placeholder="City, ST  /  State  /  Zipcode" value={input.value} onChange={(e) => this.searchInputChange(idx,e)} onKeyPress={(e) => this.searchSubmit(idx, e)} />
